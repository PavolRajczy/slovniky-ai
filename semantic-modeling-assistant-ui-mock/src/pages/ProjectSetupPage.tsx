    ...
    <div className="mx-auto max-w-4xl space-y-8">
      ...
      <section className="rounded-2xl border border-slate-200/80 bg-white p-6 shadow-sm">
        <h3 className="text-sm font-semibold uppercase tracking-wide text-slate-500">
          ...
          <span className="ml-2 rounded-md bg-amber-50 px-2 py-0.5 text-[11px] font-semibold normal-case text-amber-900">
            mock — wired in a later step
          </span>
        </h3>
        <p className="mt-1 text-sm text-slate-600">
          Upload a key document for area analysis and supplementary expert documents for retrieval. The
          listing below still shows mock data; the next commit (Commit 4) wires this section to the
          backend.
        </p>
